...
export const metadata: Metadata = {
  title: 'Terms and Conditions - Pana MIA Club',
  description: 'Terms and Conditions for Pana MIA Club',
};
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <div className="container mx-auto max-w-4xl px-4 py-12">
        ...
        <article className="prose prose-gray dark:prose-invert prose-headings:font-bold prose-h3:text-2xl prose-p:mb-4 prose-ul:my-4 prose-li:my-2 max-w-none leading-relaxed">
          <section className="space-y-4">
            ...
            <p>
              ...
              registered in Florida, United States at 17904 SW 35th Street,
              Miramar FL 33029.
            </p>
            <p>
              We operate the website www.panamia.club (the{' '}
              <strong>"Site"</strong>
              ), as well as any other related products and services that refer
              or link to these legal terms (the <strong>"Legal Terms"</strong>)
            ...
            <p>
              ...
              economies. By connecting locals with quality resources and
              educating on the benefits of reinvesting locally, we cultivate
              financial security, personal engagement, and emphasize the power
            ...
            <p>
              ...
              the arbitration will take place in Palm Beach County, Florida.
            ...
            <p>
              ...
              state and federal courts located in Palm Beach County, Florida,
            ...
            <p>
              ...
              PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING OR $150.00 USD.
